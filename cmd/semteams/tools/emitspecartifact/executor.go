...
*Generated by semteams dev-via-spec arc. This document is the structured terminal output of an LLM-mediated chain (research → plan → reviewer → architect → reviewer). Hand-edits to this file will be overwritten if the chain re-runs.*
`
