...
// Warn log; the caller treats absence as "no chain override
// available" and falls through to LLM-supplied values + title-derived
// slug.
//
// chainReader=nil (test contexts, deployments without chain wiring)
// returns an empty map without logging — the documented
// backward-compatible mode. Mirrors emitplan / emitconsensus.
