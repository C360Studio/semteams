// Package client provides an HTTP client for TrustGraph REST APIs.
//
...
//
//	// Query triples
//	triples, err := client.QueryTriples(ctx, client.TriplesQueryParams{
//	    Subject: &client.TGValue{V: "http://example.org/entity", E: true},
//	    Limit:   100,
//	})
//
//	// Store triples
