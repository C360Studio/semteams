...
// createTestGraphIndexSpatialComponent creates a test instance for lifecycle testing.
func createTestGraphIndexSpatialComponent() component.LifecycleComponent {
...
func TestGraphIndexSpatial_ComprehensiveLifecycle(t *testing.T) {
	component.StandardLifecycleTests(t, createTestGraphIndexSpatialComponent)
}
