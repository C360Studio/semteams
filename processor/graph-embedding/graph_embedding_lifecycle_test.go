...
// createTestGraphEmbeddingComponent creates a test instance for lifecycle testing.
func createTestGraphEmbeddingComponent() component.LifecycleComponent {
...
func TestGraphEmbedding_ComprehensiveLifecycle(t *testing.T) {
	component.StandardLifecycleTests(t, createTestGraphEmbeddingComponent)
}
