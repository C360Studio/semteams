...
// mockSummarizer is a test double for agenticloop.Summarizer.
...
func TestCompactor_Compact_WithLLMSummarizer(t *testing.T) {
	...
	cm := agenticloop.NewContextManager("loop-llm", "gpt-4o", config)
...
func TestCompactor_Compact_SummarizerError_FallsBack(t *testing.T) {
	...
	compactor := agenticloop.NewCompactor(config, agenticloop.WithSummarizer(mock))
	cm := agenticloop.NewContextManager("loop-fallback", "gpt-4o", config)
...
func TestCompactor_Compact_SummaryBudgetClamping(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			compactor := agenticloop.NewCompactor(config, agenticloop.WithSummarizer(mock))
			cm := agenticloop.NewContextManager("loop-clamp", "gpt-4o", config)
...
func TestCompactor_Compact_NilSummarizer_UsesStub(t *testing.T) {
	...
	cm := agenticloop.NewContextManager("loop-stub", "gpt-4o", config)
...
func TestCompactor_Compact_ModelFieldSet_WithLLMSummarizer(t *testing.T) {
	...
	compactor := agenticloop.NewCompactor(config, agenticloop.WithSummarizer(mock), agenticloop.WithModelName("fast"))
	cm := agenticloop.NewContextManager("loop-model-field", "gpt-4o", config)
...
func TestNewLLMSummarizer_NilLogger(t *testing.T) {
	...
	// Should not panic
	summarizer := agenticloop.NewLLMSummarizer(client, nil)
	if summarizer == nil {
