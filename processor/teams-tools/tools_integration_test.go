...
func (m *integrationMockExecutor) ListTools() []teams.ToolDefinition {
...
func TestIntegration_ToolExecution(t *testing.T) {
	...
	// Register mock tool
	toolsComp, ok := comp.(*teamtools.Component)
	require.True(t, ok)
...
func TestIntegration_ToolListRequestReply(t *testing.T) {
	...
	// Parse response
	var response teamtools.ToolListResponse
...
func TestIntegration_GlobalRegistryTools(t *testing.T) {
	...
	err := teamtools.RegisterTool("global_test_tool", globalTool)
	require.NoError(t, err)
...
func TestIntegration_GlobalRegistryExecution(t *testing.T) {
	...
	err := teamtools.RegisterTool("global_exec_tool", globalExecTool)
	require.NoError(t, err)
