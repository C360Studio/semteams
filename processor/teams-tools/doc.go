// Package teamtools provides the tool execution processor for the SemStreams agentic system.
//
// # Overview
//
...
//	}
//
//	func (f *FileReader) ListTools() []teams.ToolDefinition {
...
//
//	comp, _ := teamtools.NewComponent(rawConfig, deps)
//	toolsComp := comp.(*teamtools.Component)
...
//	}
//
//	func (m *MockExecutor) ListTools() []teams.ToolDefinition {
//	    return []teams.ToolDefinition{{Name: "mock_tool"}}
//	}
//
//	// In test
//	config := teamtools.Config{
