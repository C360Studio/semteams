...
type MessageHandler struct {
	...
	compactor         *Compactor
	toolCallFilter    teams.ToolCallFilter
...
func (h *MessageHandler) SetToolCallFilter(filter teams.ToolCallFilter) {
...
func (h *MessageHandler) discoverTools() []teams.ToolDefinition {
	return teamtools.ListRegisteredTools()
}
