...
func TestCompactor_ShouldCompact(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			targetTokens := int(float64(teamsloop.DefaultContextLimit) * tt.utilization)
...
func TestCompactor_Compact_PreservesSystemPrompt(t *testing.T) {
	...
	systemTokensBefore := cm.GetRegionTokens(teamsloop.RegionSystemPrompt)
	...
	systemTokensAfter := cm.GetRegionTokens(teamsloop.RegionSystemPrompt)
...
func TestCompactor_Compact_UpdatesCompactedRegion(t *testing.T) {
	...
	compactedTokensBefore := cm.GetRegionTokens(teamsloop.RegionCompactedHistory)
	...
	compactedTokensAfter := cm.GetRegionTokens(teamsloop.RegionCompactedHistory)
...
func TestCompactor_Compact_ReducesRecentHistory(t *testing.T) {
	...
	recentTokensBefore := cm.GetRegionTokens(teamsloop.RegionRecentHistory)
	...
	recentTokensAfter := cm.GetRegionTokens(teamsloop.RegionRecentHistory)
...
func TestCompactor_Compact_NetTokenReduction(t *testing.T) {
	...
	targetTokens := int(float64(teamsloop.DefaultContextLimit) * 0.70)
	fillContextToTokens(t, cm, targetTokens)

	totalTokensBefore := 0
	for _, region := range []teamsloop.RegionType{
		teamsloop.RegionSystemPrompt,
		teamsloop.RegionCompactedHistory,
		teamsloop.RegionRecentHistory,
		teamsloop.RegionToolResults,
		teamsloop.RegionHydratedContext,
	} {
...
func TestCompactor_RecompactionCapsCompactedHistory(t *testing.T) {
	...
	config.HeadroomTokens = 0
	compactor := teamsloop.NewCompactor(config)
	cm := teamsloop.NewContextManager("loop-recompact", "gpt-4o", config)
	ctx := context.Background()
	...
	compactedTokens := cm.GetRegionTokens(teamsloop.RegionCompactedHistory)
...
func TestCompactor_RecompactionWithLLMSummarizer(t *testing.T) {
	...
	cm := teamsloop.NewContextManager("loop-recompact-llm", "gpt-4o", config)
	ctx := context.Background()
...
func TestCompactor_RecompactionReducesTokens(t *testing.T) {
	...
	config.HeadroomTokens = 0
	compactor := teamsloop.NewCompactor(config)
	cm := teamsloop.NewContextManager("loop-token-check", "gpt-4o", config)
	ctx := context.Background()
	...
	tokensAfter := cm.GetRegionTokens(teamsloop.RegionCompactedHistory)
...
func TestCompactor_RetainsPendingToolCalls(t *testing.T) {
	...
	config.HeadroomTokens = 0
	compactor := teamsloop.NewCompactor(config)
	cm := teamsloop.NewContextManager("loop-retain", "gpt-4o", config)
	ctx := context.Background()
