// Package teamsmodel provides the model integration processor for the SemStreams agentic system.
//
// # Overview
//
...
//	}
//
// The processor converts between teams.ToolDefinition and OpenAI's function schema
