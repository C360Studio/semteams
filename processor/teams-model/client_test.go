...
func TestNewClient_ValidConfig(t *testing.T) {
	...
	client, err := teamsmodel.NewClient(endpoint)
	if err != nil {
...
func fastRetryConfig(maxAttempts int) teamsmodel.RetryConfig {
	return teamsmodel.RetryConfig{
...
func newTestClient(t *testing.T, serverURL string, cfg teamsmodel.RetryConfig) *teamsmodel.Client {
	t.Helper()
	endpoint := &model.EndpointConfig{
		URL:       serverURL,
		Model:     "gpt-4",
...
func TestChatCompletion_WithThrottle(t *testing.T) {
	...
	throttle := teamsmodel.NewEndpointThrottle(0, 1) // 0 rps limit, 1 concurrent
...
func TestChatCompletion_ThrottleContextCancellation(t *testing.T) {
	...
	throttle := teamsmodel.NewEndpointThrottle(0, 1)
...
func TestChatCompletion_SetRetryConfig(t *testing.T) {
	...
	client := newTestClient(t, server.URL, teamsmodel.RetryConfig{
		MaxAttempts:    5,
		Backoff:        "exponential",
		InitialDelay:   "1ms",
		MaxDelay:       "5ms",
