...
//
// Migration note (chat-redesign Phase 1): Updated MINIMAL_REQUEST to use the new
// context field instead of currentFlow. The onDone tests now check for attachments
// rather than flow/validationResult in the done payload.
