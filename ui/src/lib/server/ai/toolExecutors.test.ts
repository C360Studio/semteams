...
//
// NOTE: These tests import from ./toolExecutors which does not yet exist.
// They will fail until the Builder creates that module.
//
// The attachment shapes tested here are the Phase 4 expanded shapes:
//   SearchResultAttachment.results: Array<{id, label, type, domain, score?}>
//   EntityDetailAttachment.entity: {id, label, type, domain, properties, relationships}
// The Builder must align $lib/types/chat.ts with these shapes.
