...
//
// NOTE: HealthStatusCard.svelte does not yet exist.
// All tests here will fail until the Builder creates that component.
//
// Expected HealthAttachment shape (must be added to $lib/types/chat.ts):
//   kind: "health"
...
//
// Builder must:
//   1. Add HealthAttachment to the MessageAttachment union in types/chat.ts
//   2. Create HealthStatusCard.svelte with data-testid="health-status-card"
//   3. Show componentName, status with color indicator, optional message,
//      optional metrics as key-value pairs, optional lastCheck timestamp
