...
//
// NOTE: EntityDetailCard.svelte does not yet exist.
// All tests here will fail until the Builder creates that component.
//
// Phase 4 EntityDetailAttachment shape (expanded from original types):
//   kind: "entity-detail"
//   entity: {
//     id: string
//     label: string
...
//   }
//
// Component props (as per architecture doc):
//   detail: EntityDetailAttachment (phase 4 shape)
