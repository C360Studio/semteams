...
// Task: Phase 3 - $effect -> event handler migration (ThreePanelLayout)
// Builder must make these tests pass without modification.
//
// P2-006: ThreePanelLayout uses two $effect blocks to sync leftPanelWidth and
// rightPanelWidth props into localLeftWidth and localRightWidth state. The fix
// replaces these with $bindable. These tests lock all observable behavior so
// the refactor is verifiably safe.
