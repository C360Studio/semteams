...
// Task: Phase 3 - $effect -> event handler migration (PropertiesPanel)
// Builder must make these tests pass without modification.
//
// Gap coverage for P2-007: the $effect that runs when `node` changes must:
//   1. Reset editedName and editedConfig to the new node's values
//   2. Clear searchQuery back to ''
//   3. Reset showDeleteConfirm to false
// These behaviors are not covered by the existing PropertiesPanel.test.ts.
