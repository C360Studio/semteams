// Package teams provides shared types for the SemStreams agentic processing system.
//
// # Overview
//
...
//
//	assistantMessage := teams.ChatMessage{
//	    Role: "assistant",
...
//
//	entity := teams.NewLoopEntity("loop_123", "task_456", "general", "gpt-4")
//
//	// State transitions
//	entity.TransitionTo(teams.LoopStatePlanning)
//	entity.TransitionTo(teams.LoopStateExecuting)
//
...
//	calls := []teams.ToolCall{{ID: "1", Name: "delete_file"}}
//
//	if err := teams.ValidateToolsAllowed(calls, allowed); err != nil {
...
//
//	trajectory := teams.NewTrajectory("loop_123")
//
//	// Record a model call
//	trajectory.AddStep(teams.TrajectoryStep{
//	    Timestamp: time.Now(),
//	    StepType:  "model_call",
//	    RequestID: "req_001",
