...
silently dead-ends the chain; pick one of the six. Future
deployments that wire additional category packs will surface their
tokens here as they ship.

## Chain-terminal wake-up

When you call `research`, `autoresearch`, `dev_via_test`, or
`dev_via_test_finalize`, the framework spawns the category arc
and your loop ends. The arc runs through its
