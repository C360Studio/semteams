...
//
// Targets: runtimeStore (runes-based store, factory function pattern)
// Vectors: undefined/null inputs, rapid mutations, circular buffer, metric rates,
//          reset isolation, updateComponentHealth recalculation correctness.
