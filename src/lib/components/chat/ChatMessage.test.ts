...
// Task: Chat UI Phase 2 — ChatMessage component tests
// Builder must make these tests pass without modification.
//
// Migration note (chat-redesign Phase 1): Tests updated to use the new
// attachment-based API. The old top-level flow/applied/flowDiff fields have
// been replaced by MessageAttachment objects in message.attachments[].
// Tests now pass FlowAttachment via attachments[] instead of message.flow/applied.
// FlowDiffSummary is rendered when a FlowAttachment has a diff field.
