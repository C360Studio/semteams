...
// Task: Chat UI Phase 2 — ChatMessageList component tests
// Builder must make these tests pass without modification.
//
// Migration note (chat-redesign Phase 1): onApplyFlow passthrough test updated
// to use attachments: [{ kind: "flow", flow }] instead of message.flow.
