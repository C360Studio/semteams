...
//
// Targets: ConfigPanel.svelte
// Vectors: null component prop, rapid component switches, schema cache miss (404),
//          JSON parse error isolation, dirty state not leaking across components.
