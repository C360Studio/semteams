...
//
// NOTE: These tests verify the TypeScript type contracts for Phase 6 additions.
// They will fail until the Builder adds HealthAttachment and FlowStatusAttachment
// to $lib/types/chat.ts.
//
// Builder must add to $lib/types/chat.ts:
//
...
//   }
//
//   And update the MessageAttachment union:
//   export type MessageAttachment =
//     | FlowAttachment
//     | SearchResultAttachment
//     | EntityDetailAttachment
//     | ErrorAttachment
//     | HealthAttachment        <-- new
//     | FlowStatusAttachment;   <-- new
