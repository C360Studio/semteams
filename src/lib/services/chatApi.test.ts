...
// ChatRequest shape (context replaces currentFlow) and the new onDone signature
// ({ attachments: MessageAttachment[] } instead of { flow?, validationResult? }).
// The old "done" event no longer carries flow/validationResult in the SSE payload;
// these are now sent as "attachment" events accumulated before "done".
